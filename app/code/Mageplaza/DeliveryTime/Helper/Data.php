...
class Data extends AbstractData
{
    ...
    {
        return !!$this->getConfigGeneral('is_enabled_delivery_time', $store);
    }
    ...
    {
        return !!$this->getConfigGeneral('is_enabled_house_security_code', $store);
    }
    ...
    {
        return !!$this->getConfigGeneral('is_enabled_delivery_comment', $store);
    }
    ...
    {
        $deliveryTimeFormat = $this->getConfigGeneral('date_format', $store);

        return $deliveryTimeFormat ?: \Mageplaza\DeliveryTime\Model\System\Config\Source\DeliveryTime::DAY_MONTH_YEAR_SLASH;
    }
